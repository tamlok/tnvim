...
-- A wrapper of find_files to search files in vim.g.t_target_dirs
function M.find_files_in_dirs(opts)
  if vim.g.t_target_dirs ~= nil then
    opts.search_dirs = vim.g.t_target_dirs
  end
