...
local options = {
  opt = {
    ...
    wrap = true, -- wrap lines longer than the width of window
    ...
    sidescrolloff = 8, -- number of columns to keep around the sides of the cursor

    wildmenu = true,
    wildmode = "list:longest,full",
    wildignore = "*.o,*.obj,*.bin,*.dll,*.exe,*.pdb,*.out,*.lib",

    confirm = true, -- ask for confirmation when handling unsaved or read-only buffers
    showmatch = true, -- Highlight matched parentheses
    matchtime = 5,
    ruler = true, -- display the ruler
    colorcolumn = "101",
...
vim.cmd("set guifont=SauceCodePro\\ Nerd\\ Font\\ Mono:h13")
