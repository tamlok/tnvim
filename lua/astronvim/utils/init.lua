...
function M.get_icon(kind, padding, no_fallback)
  ...
  if not M[icon_pack] then
    M.icons = require "astronvim.icons.nerd_font"
    M.text_icons = require "astronvim.icons.text"
  end
...
function M.show_current_symbol()
  local msg = 'Symbols unavailable yet';
  if package.loaded['nvim-treesitter'] then
    msg = require('nvim-treesitter').statusline()
  end
  vim.notify(msg, vim.log.levels.INFO, { title = 'Symbol' })
end
